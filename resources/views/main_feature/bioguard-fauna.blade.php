...
const faunaData = {
    'id-ac': { name: 'Aceh', species: [{ name: 'Harimau Sumatera', status: 'Kritis', icon: '🐅' }, { name: 'Gajah Sumatera', status: 'Kritis', icon: '🐘' }, { name: 'Orangutan Sumatera', status: 'Kritis', icon: '🦧' }], value: 180 },
    'id-su': { name: 'Sumatera Utara', species: [{ name: 'Orangutan Sumatera', status: 'Kritis', icon: '🦧' }, { name: 'Siamang', status: 'Rentan', icon: '🐒' }], value: 165 },
    'id-sb': { name: 'Sumatera Barat', species: [{ name: 'Harimau Sumatera', status: 'Kritis', icon: '🐅' }, { name: 'Tapir Asia', status: 'Rentan', icon: '🐗' }], value: 145 },
    'id-ri': { name: 'Riau', species: [{ name: 'Gajah Sumatera', status: 'Kritis', icon: '🐘' }, { name: 'Harimau Sumatera', status: 'Kritis', icon: '🐅' }], value: 155 },
    'id-ja': { name: 'Jambi', species: [{ name: 'Harimau Sumatera', status: 'Kritis', icon: '🐅' }, { name: 'Beruang Madu', status: 'Rentan', icon: '🐻' }], value: 140 },
    'id-be': { name: 'Bengkulu', species: [{ name: 'Harimau Sumatera', status: 'Kritis', icon: '🐅' }, { name: 'Kambing Sumatera', status: 'Rentan', icon: '🐐' }], value: 130 },
    'id-1024': { name: 'Sumatera Selatan', species: [{ name: 'Gajah Sumatera', status: 'Kritis', icon: '🐘' }], value: 125 },
    'id-la': { name: 'Lampung', species: [{ name: 'Badak Sumatera', status: 'Kritis', icon: '🦏' }, { name: 'Gajah Sumatera', status: 'Kritis', icon: '🐘' }], value: 160 },
    'id-jk': { name: 'DKI Jakarta', species: [{ name: 'Elang Bondol', status: 'Rentan', icon: '🦅' }], value: 45 },
    'id-jb': { name: 'Jawa Barat', species: [{ name: 'Macan Tutul Jawa', status: 'Kritis', icon: '🐆' }, { name: 'Owa Jawa', status: 'Rentan', icon: '🐒' }, { name: 'Surili', status: 'Rentan', icon: '🐒' }], value: 175 },
    'id-bt': { name: 'Banten', species: [{ name: 'Badak Jawa', status: 'Kritis', icon: '🦏' }, { name: 'Banteng', status: 'Rentan', icon: '🐃' }], value: 185 },
    'id-jt': { name: 'Jawa Tengah', species: [{ name: 'Macan Tutul Jawa', status: 'Kritis', icon: '🐆' }, { name: 'Lutung Jawa', status: 'Rentan', icon: '🐒' }], value: 135 },
    'id-yo': { name: 'DI Yogyakarta', species: [{ name: 'Penyu Hijau', status: 'Rentan', icon: '🐢' }], value: 75 },
    'id-ji': { name: 'Jawa Timur', species: [{ name: 'Banteng', status: 'Rentan', icon: '🐃' }, { name: 'Merak Hijau', status: 'Rentan', icon: '🦚' }, { name: 'Rusa Timor', status: 'Aman', icon: '🦌' }], value: 165 },
    'id-ba': { name: 'Bali', species: [{ name: 'Jalak Bali', status: 'Kritis', icon: '🐦' }, { name: 'Banteng', status: 'Rentan', icon: '🐃' }], value: 120 },
    'id-nb': { name: 'Nusa Tenggara Barat', species: [{ name: 'Rusa Timor', status: 'Aman', icon: '🦌' }], value: 95 },
    'id-nt': { name: 'Nusa Tenggara Timur', species: [{ name: 'Komodo', status: 'Rentan', icon: '🦎' }, { name: 'Rusa Timor', status: 'Aman', icon: '🦌' }, { name: 'Kuda Sumba', status: 'Aman', icon: '🐴' }], value: 195 },
    'id-kb': { name: 'Kalimantan Barat', species: [{ name: 'Orangutan Kalimantan', status: 'Kritis', icon: '🦧' }, { name: 'Bekantan', status: 'Rentan', icon: '🐒' }], value: 205 },
    'id-kt': { name: 'Kalimantan Tengah', species: [{ name: 'Orangutan Kalimantan', status: 'Kritis', icon: '🦧' }, { name: 'Pesut Mahakam', status: 'Kritis', icon: '🐬' }], value: 215 },
    'id-ks': { name: 'Kalimantan Selatan', species: [{ name: 'Bekantan', status: 'Rentan', icon: '🐒' }, { name: 'Beruang Madu', status: 'Rentan', icon: '🐻' }], value: 175 },
    'id-ki': { name: 'Kalimantan Timur', species: [{ name: 'Orangutan Kalimantan', status: 'Kritis', icon: '🦧' }, { name: 'Pesut Mahakam', status: 'Kritis', icon: '🐬' }, { name: 'Macan Dahan', status: 'Rentan', icon: '🐆' }], value: 235 },
    'id-ku': { name: 'Kalimantan Utara', species: [{ name: 'Orangutan Kalimantan', status: 'Kritis', icon: '🦧' }, { name: 'Banteng', status: 'Rentan', icon: '🐃' }], value: 195 },
    'id-sa': { name: 'Sulawesi Utara', species: [{ name: 'Tarsius Sulawesi', status: 'Rentan', icon: '🐒' }, { name: 'Maleo', status: 'Rentan', icon: '🐦' }], value: 165 },
    'id-st': { name: 'Sulawesi Tengah', species: [{ name: 'Anoa', status: 'Rentan', icon: '🐃' }, { name: 'Babirusa', status: 'Rentan', icon: '🐗' }], value: 185 },
    'id-sg': { name: 'Sulawesi Tenggara', species: [{ name: 'Anoa Dataran Rendah', status: 'Rentan', icon: '🐃' }], value: 145 },
    'id-sn': { name: 'Sulawesi Selatan', species: [{ name: 'Kuskus Sulawesi', status: 'Rentan', icon: '🐨' }, { name: 'Tarsius', status: 'Rentan', icon: '🐒' }], value: 155 },
    'id-sw': { name: 'Sulawesi Barat', species: [{ name: 'Anoa Pegunungan', status: 'Rentan', icon: '🐃' }], value: 125 },
    'id-go': { name: 'Gorontalo', species: [{ name: 'Maleo', status: 'Rentan', icon: '🐦' }], value: 115 },
    'id-ma': { name: 'Maluku', species: [{ name: 'Kakatua Maluku', status: 'Rentan', icon: '🦜' }, { name: 'Nuri Raja', status: 'Rentan', icon: '🦜' }], value: 175 },
    'id-mu': { name: 'Maluku Utara', species: [{ name: 'Bidadari Halmahera', status: 'Rentan', icon: '🐦' }], value: 155 },
    'id-pa': { name: 'Papua', species: [{ name: 'Cenderawasih', status: 'Rentan', icon: '🐦' }, { name: 'Kanguru Pohon', status: 'Rentan', icon: '🦘' }, { name: 'Kasuari', status: 'Rentan', icon: '🐦' }], value: 285 },
    'id-pb': { name: 'Papua Barat', species: [{ name: 'Cenderawasih Merah', status: 'Rentan', icon: '🐦' }, { name: 'Kakatua Raja', status: 'Rentan', icon: '🦜' }, { name: 'Penyu Belimbing', status: 'Kritis', icon: '🐢' }], value: 265 }
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Highcharts.maps['countries/id/id-all'].features.forEach(function(f) {
        ...
        mapData.push({ 'hc-key': code, value: faunaData[code]?.value || 100, name: f.properties.name });
    });
    ...
    Highcharts.mapChart('fauna-map', {
        ...
        colorAxis: { min: 50, max: 300, stops: [[0, '#fef3c7'], [0.3, '#fbbf24'], [0.6, '#f59e0b'], [1, '#b45309']] },
        tooltip: {
            useHTML: true,
            formatter: function() {
        ...
        series: [{
            ...
            borderColor: 'white',
            borderWidth: 1,
            states: { hover: { color: '#f59e0b', borderWidth: 2 } },
            cursor: 'pointer',
            point: { events: { click: function() { showFaunaDetail(this['hc-key'], this.name); } } }
        }]
    });
});

function showFaunaDetail(code, name) {
    const d = faunaData[code] || { name: name, species: [{ name: 'Fauna Lokal', status: 'Aman', icon: '🦋' }], value: 100 };
